...
public class DrillsEditorWindow : OdinMenuEditorWindow {
    ...
    protected override OdinMenuTree BuildMenuTree() {
        ...
        tree.AddAllAssetsAtPath("", MovesDir, typeof(DrillData), true, true);
    ...
    OdinMenuItem CreateNewMove() {
        var teamMenuver = CreateInstance<DrillData>();
        teamMenuver.CharsData.Add(new CharData());
        ValidateDir();
        var assetPath = AssetDatabase.GenerateUniqueAssetPath(MovesDir + "/NewDrill.asset");
    ...
    OdinMenuItem AddMoveToTree(string assetPath) {
        ...
        MenuTree.AddAssetAtPath(assetPath, assetPath, typeof(DrillData));
    ...
    void OnSelection() {
        ...
        if (MenuTree.Selection.SelectedValue is DrillData move) {
